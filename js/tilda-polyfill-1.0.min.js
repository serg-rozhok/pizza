Array.prototype.forEach ||
  ...
  window.document.querySelectorAll ||
    (document.querySelectorAll =
      ...
      Object.querySelectorAll =
        function querySelectorAllPolyfill(e, t, r, n, o) {
          var i = document,
            c = i.createStyleSheet();
          for (
            o = i.all,
              t = [],
              r = (e = e.replace(/\[for\b/gi, "[htmlFor").split(",")).length;
            r--;

          ) {
            for (c.addRule(e[r], "k:v"), n = o.length; n--; )
  ...
  !window.getComputedStyle &&
    ...
    (window.getComputedStyle = function getComputedStylePolyfill(e) {
  ...
  Array.from ||
    (Array.from = (function () {
      ...
      return function from(e) {
        ...
        for (
          var i = toLength(r.length),
            c = isCallable(t) ? Object(new t(i)) : new Array(i),
            a = 0,
            l;
          a < i;
          ...
          (l = r[a]),
            (c[a] = n ? (void 0 === o ? n(l, a) : n.call(o, l, a)) : l),
            (a += 1);
        return (c.length = i), c;
      };
    })());
