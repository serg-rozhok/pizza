...
function t_zoom__updateSlidesHeight() {
  ...
  n &&
    ...
    isNaN(o) ||
      setTimeout(function () {
        var e,
          t = document.querySelector(".t-carousel__zoomer__item.active");
        t &&
  ...
  var e = t.closest(".r"),
    ...
    _ =
      ((e ? e.querySelector(".t-slds") : null) &&
        ...
        t &&
          t.querySelector(".tn-elem__gallery__video-wrapper") &&
    ...
    Array.prototype.forEach.call(r, function (t) {
      var e = t.querySelector(".t-carousel__zoomer__img"),
        ...
        t =
          ...
          (e.style.maxHeight =
            document.documentElement.clientHeight - n + "px"),
          o &&
            -1 !== o.indexOf(".svg") &&
      ...
      i.addEventListener(
        ...
        function (t) {
          ...
          ((window.t_zoom__isMobile &&
            ...
            (e.style.maxHeight = ""),
            i.classList.contains("scale-active")
              ? t_zoom_unscale()
...
function t_zoom_desktopZoomPositioningInit(e, t) {
  var o,
    ...
    n,
    i,
    a = (window.innerWidth - e.offsetWidth) / 2,
...
function t_zoom_mobileZoomPositioningInit(o) {
  var r = (window.innerWidth - o.offsetWidth) / 2,
    ...
    i = ((o.style.left = r + "px"), (o.style.top = n + "px"), { x: 0, y: 0 }),
    a = {},
    l = {};
...
function t_zoom_unscale() {
  ...
  n &&
    ...
    a &&
      ...
      (o =
        o +
        (e = window.t_zoom__isMobile
          ? a.getAttribute("data-max-comment-height") || e
          : e)),
      (t.onmousemove = null),
      (t.ontouchmove = null),
      (t.style.transform = ""),
    ...
    void 0 !== n.offsetLeft &&
      void 0 !== n.offsetTop &&
      ((a = n.offsetLeft), (i.style.transform = "translateX(" + -a + "px)")),
...
function t_zoom_setModalColor(t) {
  var e,
    ...
    i = (
      -1 !== (i = i || r).indexOf("-gradient(")
        ? t_zoom_getFirstColorFromGradient
        : t_zoom_hexToRgb
    )(i),
    t =
